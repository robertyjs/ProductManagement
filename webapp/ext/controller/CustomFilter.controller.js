	...
	return sap.ui.controller("nw.epm.refapps.st.prod.manage.ext.controller.CustomFilter", {
		...
		onInitSmartFilterBarExtension: function(oEvent) {
			...
			this.fnAddTokensFromMultiInput = function() {
				...
				//var oSupplierCustomControl = this.byId("listReportFilter").getControlByKey("Supplier");
				...
				//var oSupplierHelpKey = this.byId("selectedSuppliers").getItems()[0].getBindingContext().getProperty("Supplier");
			};
		},
